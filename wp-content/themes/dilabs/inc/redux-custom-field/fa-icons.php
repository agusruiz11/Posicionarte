...
// the opt_name is set to dilabs_opt.  Please replace it if change your opt_name name.
add_action( 'redux/page/dilabs_opt/enqueue', 'dilabs_faIconFont' );
function dilabs_faIconFont() {
	
  //  Font awesome enqueue
  wp_enqueue_style( 'font-awesome', DILABS_DIR_CSS_URI.'font-awesome.min.css', array(), '4.7.0', 'all' );
  
  // Redux admin css enqueue
  wp_enqueue_style( 'dilabs-redux-admin', DILABS_DIR_URI.'inc/redux-custom-field/assets/dilabs.redux.admin.css', array(), '1.0' );
  
  // Redux admin js enqueue
  wp_enqueue_script( 'dilabs-redux-admin', DILABS_DIR_URI.'inc/redux-custom-field/assets/dilabs.redux.admin.js', array( 'jquery' ), '1.0', true );
