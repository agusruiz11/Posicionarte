...
// image default alt
if( !function_exists( 'dilabs_img_default_alt' ) ){
	function dilabs_img_default_alt( $url = '' ){
...
// Image Tag
if( !function_exists( 'dilabs_img_tag' ) ){
	function dilabs_img_tag( array $args ){
		...
		if( !empty( $args['alt'] ) ){
			...
			$alt = dilabs_img_default_alt( $site_name );
		}
...
// Anchor Tag
if( !function_exists( 'dilabs_anchor_tag' ) ){
	function dilabs_anchor_tag( array $args ){
...
// Heading Tag
if( !function_exists( 'dilabs_heading_tag' ) ){
	function dilabs_heading_tag( array $args ){

		$default = array(
			'tag' 	 	  => 'h1',
			'text' 	 	  => __( 'Write Something', 'dilabs' ),
			'class'  	  => '',
			'id' 	 	  => '',
			'data-animate'=> '',
			'data-delay'  => '',
...
// Paragraph Tag
if( !function_exists( 'dilabs_paragraph_tag' ) ){
	function dilabs_paragraph_tag( array $args ){
...
// Other Tag
if( !function_exists( 'dilabs_span_tag' ) ){
	function dilabs_span_tag( array $args ){
