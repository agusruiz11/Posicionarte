...
* @version  1.0
* @package  Dilabs
* @author   Dilabs <support@vecurosoft.com>
*
...
class dilabs_recent_posts_widget extends WP_Widget {

        function __construct() {

            parent::__construct(
                // Base ID of your widget
                'dilabs_recent_posts_widget',

                // Widget name will appear in UI
                esc_html__( 'Dilabs :: Recent Posts', 'dilabs' ),

                // Widget description
                array(
                    'classname'                     => 'recent-post',
                    'customize_selective_refresh'   => true,
                    'description'                   => esc_html__( 'Add Recent Posts Widget', 'dilabs' ),
                )
            );
        }
                        ...
                        echo '<li>';
                            if( has_post_thumbnail() ){
                                echo '<div class="thumb">';
                                    the_post_thumbnail( 'dilabs_80X80' );
                                echo '</div>';
                            }
                            echo '<div class="info">';
                                if( $show_date ){
        ...
        public function form( $instance ) {
            ...
            <p>
                <label for="<?php echo $this->get_field_id( 'post_count' ); ?>"><?php _e( 'Number of Posts to show:' ,'dilabs'); ?></label>
    ...
    } // Class dilabs_recent_posts_widget ends here


    // Register and load the widget
    function dilabs_recent_posts_load_widget() {
        register_widget( 'dilabs_recent_posts_widget' );
    }
    add_action( 'widgets_init', 'dilabs_recent_posts_load_widget' );